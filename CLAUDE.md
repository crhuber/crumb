...
- **Storage backend**: Pluggable Backend interface, currently backed by local files
...
- **`pkg/backend`**: Storage backend abstraction (`Backend` interface, `FileBackend`, factory)
